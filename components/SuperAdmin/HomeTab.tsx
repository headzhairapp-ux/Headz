        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between mb-4">
            ...
            <select
              ...
              className="bg-gray-700 text-white text-sm rounded-lg px-3 py-1.5 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <a
            ...
            className="flex items-center space-x-4 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700 hover:border-green-500/50 hover:bg-gray-800/70 transition-all duration-300 group"
          >
            ...
            <div>
              <h3 className="text-white font-medium group-hover:text-green-400 transition-colors">Gemini API Billing</h3>
              <p className="text-gray-400 text-sm">View usage & costs</p>
              <p className="text-yellow-400 text-xs mt-1">Open with headzhairapp@gmail.com</p>
            </div>
          </a>
        </div>
      </div>
