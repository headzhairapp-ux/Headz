...
const SuperAdminLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-purple-800 flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <Link to="/" className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent">
              Headz International
            </Link>
          </div>
          <div className="mt-2 inline-flex items-center px-3 py-1 bg-purple-600 text-white text-sm rounded-full font-medium">
          ...
          <div className="flex justify-center">
            {isLoading ? (
              <div className="flex items-center justify-center py-3">
                <svg className="animate-spin h-6 w-6 text-purple-500 mr-3" fill="none" viewBox="0 0 24 24">
